...
const EMAIL_ONLY_SUCCSS_TEXT = "subscribing to the Politics Brief";
const PHONE_ONLY_SUCCSS_TEXT = "on the list";
const BOTH_SUCCESS_TEXT = "Thanks for signing up";
...
describe("Overall testing", function() {
  ...
  it("Has correct title", function() {
    cy.title().should('eq', '2018 Elections | Get Updates');
  });
});
