...
export default Component.extend({
  ...
  setItems: observer('hasLoaded', function() {
    ...
    if (this.get('hasLoaded')){
      let wNYCUnshown = this.get('wNYCItems').slice((this.get('pageWNYC') - 2) * this.get('pageSize'));
      let gothUnshown = this.get('gothItems').slice((this.get('pageGoth') - 2) * this.get('pageSize'));
